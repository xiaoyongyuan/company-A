...
import { DatePicker,Row,Col,Select,Button,Icon,Modal } from "antd";
        ...
        axios.get("ztt.json").then((res)=>{
            ...
            if(res.data.success){
                this.setState({
                    ...
                    console.log(this.state.policeList)
                });
            }
        })
                                ...
                                <Row>
                                    <Col xl={3} xxl={2}>
                                        <div className="handle">
                                            <div className={v.static?"stateBackground":""}>{v.state}</div>
                                        </div>
                                    </Col>
                                    <Col xl={9} xxl={7} className="policeIcon">
                                        ...
                                        <div className="camera" onClick={this.showModal}><Icon type="video-camera" theme="filled" /></div>
                                    </Col>
                                    <Col xl={11} xxl={12}>
                                        <div className="policeContext">
                                            ...
                                            <Row className="line-police">
                                                ...
                                                <Col xl={12} xxl={12}>{v.police}</Col>
                                            </Row>
                                            <Row className="line-police">
                                                <Col xl={12} xxl={12}>{v.times}</Col>
                                                <Col xl={12} xxl={12}>报警对象：{v.policeObject}</Col>
                                            </Row>
                                            <Row className="line-police">
