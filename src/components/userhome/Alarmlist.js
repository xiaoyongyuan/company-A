            ...
            <div>
                ...
                <Row style={{marginTop: "70px", display: this.state.type === 0 ? "block" : "none"}}>
                    <Col style={{width: "100%", textAlign: "center"}}>
                        <div className="backImg"><img src={nodata} alt="" /></div>
                    </Col>
                </Row>
                            ...
                            <Col xl={12} xxl={12} lg={12} style={{marginTop: "40px"}} key={i}>
                                <Row>
                                    ...
                                    <Col xl={9} xxl={7} lg={9} className="policeIcon">
                                        ...
                                        <div className="camera" style={{display: v.videopath > 1 ? "block" : "none"}} onClick={this.handleCamera}>
                                    ...
                                    <Col xl={11} xxl={12} lg={12}>
                                        <div className="policeContext">
                                            ...
                                            <Row className="line-police" style={{borderTop: "1px solid #efefef",paddingTop: '5px'}}>
                                                <Col xl={8} xxl={8} lg={8}><span onClick={() => this.alarmdeal(v.code, i, 1)} className="cursor">
                                                    <span className="iconfont icon-queren iconColor2" />&nbsp;确认</span></Col>
                                                <Col xl={8} xxl={8} lg={8}><span onClick={() => this.alarmdeal(v.code, i, 3)} className="cursor">
                                                    <span className="iconfont icon-baojing iconColor1" />&nbsp;虚警</span></Col>
                                                <Col xl={8} xxl={8} lg={8}><span onClick={() => this.alarmdeal(v.code, i, 2)} className="cursor">
                                                    <span className="iconfont icon-hulve iconColor3" />&nbsp;忽略</span></Col>
                                            </Row>
                                        </div>
                                    </Col>
                                </Row>
